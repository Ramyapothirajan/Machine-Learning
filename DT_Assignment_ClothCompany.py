...
df = pd.read_csv("C:/Users/RamyaRajaLakshmi/Documents/My_Course/Machine Learning/13. Decision Tree_flask_final/ClothCompany_Data.csv")
...
contingency_table = pd.crosstab(Y_Test, Prediction, rownames = ['Actual'], colnames= ['Predictions']) 
...
# GridSearchCV is a scikit-learn class that performs an exhaustive search over a specified hyperparameter grid.
...
# Prediction on Test Data
pred_1 = DT_best.predict(X_Test)
pred_1

pd.crosstab(Y_Test, pred_1,  rownames = ['Actual'], colnames= ['Predictions']) 
...
# save the best model with pickle library
pickle.dump(DT_best, open('DT.pkl', 'wb'))

# Plot visualization
cm = skmet.confusion_matrix(Y_Test, pred_1)
...
Decision_Tree_result = cross_validation(DT_best, X_Train, Y_Train, 4)
